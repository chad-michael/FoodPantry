...
namespace FoodPantry.Data.Models
{
    ...
    [Table("FoodPantryLog")]
    public partial class oldFoodPantryLog
    {
        ...
        [DisplayName("Enrollment Status")]
        public virtual oldEnrollmentStatus EnrollmentStatus { get; set; }

        [DisplayName("Info Sources")]
        public virtual oldInfoSource InfoSource { get; set; }

        [DisplayName("Student Type")]
        [ForeignKey("StudentType")]
        public virtual oldStudentType StudentType1 { get; set; }

        [DisplayName("location desc")]
        [ForeignKey("Location of Intake")]
        public virtual oldLocation Location { get; set; }
    }
}